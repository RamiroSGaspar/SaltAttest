...
**SaltaDev Trust** es una red social cerrada de SaltaDev donde los miembros arman su perfil con su información técnica y, sobre todo, **se avalan entre sí**. El aval de la comunidad es lo que convierte un perfil de *"¡lo que yo digo de mí"* en *"lo que la comunidad confirma de mí"*.
...
**SaltaDev Trust no es un LinkedIn más chico ni una bolsa de empleo.** Es, ante todo, una herramienta de comunidad.
...
Todas las entidades usan `app: "saltrust"` como namespace, garantizando que las consultas de SaltaDev Trust nunca colisionen con otras apps en Arkiv.
...
El buscador recibe la lista de perfiles con sus estrellas y el texto de búsqueda libre. El código filtra y rankea por relevancia y estrellas; Claude escribe la presentación en lenguaje natural. La API key nunca se expone al cliente; la llamada a Anthropic ocurre server-side en `api/buscar.ts`.

---

## Equipo

- Ramiro Sebastián Gaspar — [@RamiroSGaspar](https://github.com/RamiroSGaspar)
- Juan Martinez — [@juanjuenio-jum](https://github.com/juanjuenio-jum)
- Gastón Saravia — [@gastonignaciosaravia](https://github.com/gastonignaciosaravia)
- Yael Arapa — [@yaelisma](https://github.com/yaelisma)
